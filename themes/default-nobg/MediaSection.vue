<template>
	<section class="z-50">
		...
		>
			<div class="w-full text-left text-3xl">Images</div>
			<div
				class="mt-5"
				v-motion
				:initial="{ opacity: 0, y: 100 }"
		...
		>
			<div class="w-full text-left text-3xl">Youtube videos</div>
			<div
				class="px-2 mt-5"
				v-motion
				:initial="{ opacity: 0, y: 100 }"
		...
		>
			<div class="w-full text-left text-3xl ">Facebook posts</div>
			<div
				class="px-2 mt-5"
				v-motion
				:initial="{ opacity: 0, y: 100 }"
		...
		>
			<div class="w-full text-left text-3xl ">Instagram posts</div>
			<div
				class="px-2 mt-5"
				v-motion
				:initial="{ opacity: 0, y: 100 }"
